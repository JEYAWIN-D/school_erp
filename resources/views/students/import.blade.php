  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" x-data="importUploader()">
    <div class="lg:col-span-2 space-y-6">
      <div class="card space-y-5">
        ...
        <form id="importForm" method="POST" action="{{ route('students.import.process') }}" enctype="multipart/form-data" @submit.prevent="submitForm($event)" class="space-y-4">
          @csrf
          ...
          <div class="pt-3 flex items-center justify-between border-t border-slate-100">
            <a href="{{ route('students.import.template') }}" class="btn btn-secondary btn-sm" :class="{ 'pointer-events-none opacity-50': isUploading }">
