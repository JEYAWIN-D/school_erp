...
<body class="bg-slate-50 min-h-screen flex items-center justify-center px-4">
  <div class="max-w-md w-full text-center bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
    ...
    <div class="bg-indigo-50 rounded-xl px-4 py-3 mb-6">
      ...
      <p class="text-2xl font-bold text-indigo-700 font-mono">{{ $app->application_number }}</p>
    </div>
    <p class="text-xs text-slate-400">Please save this number for future reference. The school will contact you on <strong>{{ $app->parent_mobile }}</strong> regarding the next steps.</p>
  </div>
</body>
</html>
