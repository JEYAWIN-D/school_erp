...
<nav id="nav">
  <div class="container">
    <div class="nav-inner">
      ...
      <div class="nav-cta">
        ...
        <a href="{{ route('login') }}" class="btn btn-primary" style="padding:.55rem 1.25rem;font-size:.875rem;">Get Started</a>
  ...
  <div id="mobile-menu" class="mobile-menu">
    ...
    <a href="#faq">FAQ</a>
    <a href="{{ route('login') }}" style="background:var(--blue);color:#fff;text-align:center;border-radius:.5rem;margin-top:.5rem;font-weight:600;">Get Started Free</a>
  </div>
</nav>
...
<section id="modules" class="modules-section">
  <div class="container">
    ...
    <div class="modules-grid">
      ...
      <div class="mod-card">
        <div class="mod-dot" style="background:{{ $mod[2] }}">
          <svg width="18" height="18" fill="none" stroke="{{ $mod[3] }}" viewBox="0 0 24 24">{!! $icons[$i] !!}</svg>
        </div>
        <div>
          <h4>{{ $mod[0] }}</h4>
          <p>{{ $mod[1] }}</p>
...
<footer>
  <div class="container">
    ...
    <div class="footer-bottom">
      <span>© {{ date('Y') }} DASA EduERP. All rights reserved.</span>
