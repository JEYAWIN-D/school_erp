...
<div class="space-y-5">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
    ...
    <div class="flex items-center gap-2 flex-wrap">
      ...
      <a href="{{ route('attendance.staff.register') }}" class="btn btn-secondary btn-sm">
  ...
  <div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
      @foreach([
        ...
        ['Staff Register',      'attendance.staff.register', 'bg-purple-50 text-purple-700 border-purple-200',   '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>'],
