<?php $__env->startSection('title', 'Staff ID Card Studio — ' . $employee->full_name); ?>
...
<div class="space-y-6 max-w-5xl mx-auto" x-data="{ activeTab: 'both' }">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm print:hidden">
    <div class="flex items-center gap-3">
      <a href="<?php echo e(route('hr.employees.show', $employee->id)); ?>" class="btn-icon" title="Back to Employee Profile">
      ...
      <div>
        ...
        <p class="page-subtitle text-xs text-slate-500 mt-0.5"><?php echo e($employee->full_name); ?> (<?php echo e($employee->employee_code); ?>) &bull; <?php echo e($employee->category_label); ?></p>
      </div>
    </div>
  ...
  <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-4 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 print:hidden">
    ...
    <form action="<?php echo e(route('hr.employees.update-photo', $employee->id)); ?>" method="POST" enctype="multipart/form-data" class="flex items-center gap-2 w-full sm:w-auto">
      <?php echo csrf_field(); ?>
      ...
      <div class="id-card-vertical relative bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col justify-between"
        ...
        <div class="relative z-10 pt-4 px-6 flex items-center justify-end">
          <div class="flex items-center gap-2 text-right">
            <div>
              <p class="text-xs font-black tracking-wider text-white uppercase leading-none drop-shadow-sm"><?php echo e(config('app.name', 'DASA EduERP')); ?></p>
        ...
        <div class="relative z-10 mt-1 flex justify-center">
          <div class="w-32 h-32 rounded-full p-1 bg-white shadow-xl ring-4 ring-blue-100 flex items-center justify-center overflow-hidden">
            <?php if($employee->photo): ?>
              <img src="<?php echo e(asset('storage/' . $employee->photo)); ?>" alt="<?php echo e($employee->full_name); ?>" class="w-full h-full rounded-full object-cover">
            <?php else: ?>
        ...
        <div class="relative z-10 text-center px-4 mt-2">
          <h2 class="text-lg font-black tracking-tight text-blue-950 uppercase leading-tight"><?php echo e($employee->full_name); ?></h2>
          <p class="text-xs font-bold text-blue-600 capitalize mt-0.5"><?php echo e($employee->designation); ?></p>
        </div>
          ...
          <table style="border-collapse: collapse; font-size: 11px; font-weight: 600; color: #1e293b; margin: 0 auto;">
            <tbody>
              <tr>
                ...
                <td style="padding: 2px 0 2px 6px; font-family: ui-monospace, monospace; font-weight: 700; color: #0f172a; text-align: left; white-space: nowrap;"><?php echo e($employee->employee_code); ?></td>
              </tr>
              <tr>
                <td style="padding: 2px 6px 2px 0; font-weight: 700; color: #1e3a8a; white-space: nowrap; text-align: left;">Email</td>
                <td style="padding: 2px 6px; color: #64748b; font-weight: 700; text-align: center;">:</td>
                <td style="padding: 2px 0 2px 6px; font-weight: 600; color: #334155; text-align: left; white-space: nowrap;"><?php echo e($employee->official_email ?? $employee->email ?? 'staff@dasaeduerp.com'); ?></td>
              </tr>
              <tr>
                <td style="padding: 2px 6px 2px 0; font-weight: 700; color: #1e3a8a; white-space: nowrap; text-align: left;">Phone</td>
                <td style="padding: 2px 6px; color: #64748b; font-weight: 700; text-align: center;">:</td>
                <td style="padding: 2px 0 2px 6px; font-family: ui-monospace, monospace; font-weight: 700; color: #0f172a; text-align: left; white-space: nowrap;">+91 <?php echo e($employee->mobile); ?></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="id-card-vertical relative bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col justify-between"
        ...
        <div class="relative z-10 px-6 mt-2">
          <div class="bg-blue-50/80 p-2.5 rounded-xl border border-blue-100 text-[10px]">
            ...
            <p class="text-slate-800 font-bold mt-0.5"><?php echo e(config('app.name', 'DASA EduERP')); ?> Main Office</p>
            <p class="text-slate-600 mt-0.5">Emergency Helpline: <span class="font-mono font-bold text-blue-900">+91 <?php echo e($employee->emergency_contact_mobile ?? $employee->mobile); ?></span></p>
          </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_erp - Copy\resources\views/hr/employee-id-card-studio.blade.php ENDPATH**/ ?>