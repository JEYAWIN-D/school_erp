<?php $__env->startSection('title', 'Fee Statement'); ?>
...
<div style="margin-bottom: 1rem; display: flex; flex-wrap: wrap; gap: .5rem;">
  <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <a href="<?php echo e(route('portal.parent.fees', ['student_id' => $c->id])); ?>"
...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: .5rem; margin-bottom: 1rem;">
  <h2 style="font-size: 1.0625rem; font-weight: 700; color: #1e293b; margin: 0;">Fee Statement — <?php echo e($child->first_name); ?> <?php echo e($child->last_name); ?></h2>
  <a href="<?php echo e(route('portal.parent.fees.pdf', ['student_id' => $child->id])); ?>" target="_blank"
     style="display: inline-flex; align-items: center; gap: .375rem; padding: .5rem 1rem; background: #2563eb; color: #fff; text-decoration: none; border-radius: .5rem; font-size: .8125rem; font-weight: 600;"
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: .875rem; margin-bottom: 1.25rem;">
  <div class="portal-card" style="text-align: center; padding: 1.25rem;">
    <div style="font-size: 1.375rem; font-weight: 700; color: #1e293b;">₹<?php echo e(number_format($totalDue)); ?></div>
  ...
  <div class="portal-card" style="text-align: center; padding: 1.25rem;">
    <div style="font-size: 1.375rem; font-weight: 700; color: #16a34a;">₹<?php echo e(number_format($totalPaid)); ?></div>
  ...
  <div class="portal-card" style="text-align: center; padding: 1.25rem; border: 2px solid <?php echo e($balance > 0 ? '#fecaca' : '#bbf7d0'); ?>;">
    <div style="font-size: 1.375rem; font-weight: 700; color: <?php echo e($balance > 0 ? '#dc2626' : '#16a34a'); ?>;">₹<?php echo e(number_format($balance)); ?></div>
    <div style="font-size: .72rem; color: #94a3b8; font-weight: 500; text-transform: uppercase; letter-spacing: .04em; margin-top: .25rem;"><?php echo e($balance > 0 ? 'Balance Due' : 'All Clear'); ?></div>
  </div>
</div>
...
<?php if($balance > 0): ?>
  <div style="padding: .875rem 1rem; background: #fef2f2; border: 1px solid #fecaca; border-radius: .75rem; color: #dc2626; font-size: .875rem; font-weight: 500; display: flex; align-items: center; gap: .5rem; margin-bottom: 1.25rem;">
    ...
    Outstanding balance of ₹<?php echo e(number_format($balance)); ?>. Please contact the school fee office.
  </div>
<?php endif; ?>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem;">
  ...
  <div class="portal-card">
    ...
    <div class="divider-row" style="display: flex; align-items: center; justify-content: space-between; padding: .625rem 0; gap: .5rem;">
      <div style="flex: 1; min-width: 0;">
        <p style="font-size: .875rem; font-weight: 500; color: #1e293b;"><?php echo e($inv->fee_head_name ?? 'Fee'); ?></p>
        <p style="font-size: .75rem; color: #94a3b8;">Due: <?php echo e(\Carbon\Carbon::parse($inv->due_date)->format('d M Y')); ?></p>
      </div>
      <div style="text-align: right; flex-shrink: 0;">
        <div style="font-size: .9375rem; font-weight: 700; color: #1e293b;">₹<?php echo e(number_format($inv->amount)); ?></div>
  ...
  <div class="portal-card">
    ...
    <div class="divider-row" style="display: flex; align-items: center; justify-content: space-between; padding: .625rem 0; gap: .5rem;">
      <div style="flex: 1;">
        <p style="font-size: .875rem; font-weight: 500; color: #1e293b;">Receipt #<?php echo e($pay->receipt_number ?? $pay->id); ?></p>
        <p style="font-size: .75rem; color: #94a3b8;"><?php echo e(\Carbon\Carbon::parse($pay->payment_date)->format('d M Y')); ?> &bull; <?php echo e(ucfirst($pay->payment_mode ?? 'Cash')); ?></p>
      </div>
      <div style="text-align: right; flex-shrink: 0;">
        <div style="font-size: .9375rem; font-weight: 700; color: #16a34a;">₹<?php echo e(number_format($pay->total_paid ?? $pay->amount ?? 0)); ?></div>
        <a href="<?php echo e(route('portal.parent.fees.receipt', array_merge(['id' => $pay->id], request()->only('student_id')))); ?>" target="_blank"
...
<?php echo $__env->make('portal.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_erp - Copy\resources\views\portal\parent\fees.blade.php ENDPATH**/ ?>