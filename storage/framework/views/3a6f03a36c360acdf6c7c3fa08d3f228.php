...
<div class="card">
  ...
  <div class="report-title">Progress Report Card &mdash; <?php echo e($exam->name); ?></div>

  <div class="info-row">
    <div class="info-box">
      <div class="info-label">Student Name</div>
      <div class="info-value"><?php echo e($row['enrollment']->student->full_name ?? ($row['enrollment']->student->first_name . ' ' . $row['enrollment']->student->last_name)); ?></div>
    </div>
    <div class="info-box">
      <div class="info-label">Admission No</div>
      <div class="info-value"><?php echo e($row['enrollment']->student->admission_no ?? $row['enrollment']->student->admission_number ?? '—'); ?></div>
    </div>
    <div class="info-box">
      <div class="info-label">Class / Roll</div>
      <div class="info-value"><?php echo e($row['enrollment']->class->name ?? ''); ?> &mdash; <?php echo e($row['enrollment']->roll_number); ?></div>
    </div>
  </div>
  ...
  <table>
    ...
    <tbody>
      <?php $__currentLoopData = $row['marks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php
      ...
      ?>
      <tr>
        <td><?php echo e($mark->examSchedule?->subject?->name ?? '—'); ?></td>
        <td><?php echo e($maxMarks); ?></td>
        <td class="<?php echo e(!$isPassed && !$mark->is_absent ? 'fail' : ''); ?>">
          <?php echo e($mark->is_absent ? 'Absent' : $mark->marks_obtained); ?>

        </td>
        <td><?php echo e($passMarks); ?></td>
        <td class="<?php echo e($isPassed ? '' : 'fail'); ?>"><?php echo e($mark->is_absent ? 'AB' : ($isPassed ? 'Pass' : 'Fail')); ?></td>
  ...
  <div class="summary-box">
    <div class="summary-item">
      <div class="summary-number"><?php echo e($row['obtained']); ?></div>
      <div class="summary-label">Marks Obtained</div>
    </div>
    <div class="summary-item">
      <div class="summary-number"><?php echo e($row['totalMarks']); ?></div>
      <div class="summary-label">Total Marks</div>
    </div>
    <div class="summary-item">
      <div class="summary-number"><?php echo e($percentage); ?>%</div>
      <div class="summary-label">Percentage</div>
    </div>
    <div class="summary-item">
      <div class="summary-number"><?php echo e($overallGrade); ?></div>
      <div class="summary-label">Overall Grade</div>
    </div>
    <div class="summary-item">
      <div class="summary-number"><?php echo e($row['hasFail'] ? 'Fail' : 'Pass'); ?></div>
  ...
  <div class="footer-note">This report card was generated on <?php echo e(now()->format('d M Y')); ?>. Please keep this for your records.</div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</body>
</html>
<?php /**PATH E:\school_erp - Copy\resources\views\pdf\bulk-report-cards.blade.php ENDPATH**/ ?>