...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'Portal'); ?> — <?php echo e(config('app.name')); ?></title>
...
<div class="ps-shell">
  ...
  <aside class="ps-sidebar" id="ps-sidebar">
    ...
    <div class="ps-logo">
      ...
      <div class="ps-logo-text">
        <p style="color:#fff;font-weight:700;font-size:.875rem;line-height:1.25;white-space:nowrap;"><?php echo e(config('app.name')); ?></p>
    ...
    <nav style="flex:1;padding:.5rem 0;">
      ...
      <?php if(auth()->user()->hasRole('parent')): ?>
        ...
        <a href="<?php echo e(route('portal.parent.dashboard')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.parent.dashboard') ? 'active' : ''); ?>" title="Dashboard">
        ...
        <a href="<?php echo e(route('portal.parent.attendance')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.parent.attendance') ? 'active' : ''); ?>" title="Attendance">
        ...
        <a href="<?php echo e(route('portal.parent.exams')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.parent.exams') ? 'active' : ''); ?>" title="Exam Results">
        ...
        <a href="<?php echo e(route('portal.parent.fees')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.parent.fees') ? 'active' : ''); ?>" title="Fees">
        ...
        <a href="<?php echo e(route('portal.parent.notices')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.parent.notices') ? 'active' : ''); ?>" title="Notices" id="ps-notices-link">
        ...
        <a href="<?php echo e(route('portal.parent.profile')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.parent.profile') ? 'active' : ''); ?>" title="Profile">
      ...
      <?php elseif(auth()->user()->hasRole('student')): ?>
        ...
        <a href="<?php echo e(route('portal.student.dashboard')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.dashboard') ? 'active' : ''); ?>" title="Dashboard">
          <svg class="ps-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
          <span class="ps-nav-label">Dashboard</span>
        </a>
        ...
        <a href="<?php echo e(route('portal.student.attendance')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.attendance') ? 'active' : ''); ?>" title="Attendance">
          <svg class="ps-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
          <span class="ps-nav-label">Attendance</span>
        </a>

        <a href="<?php echo e(route('portal.student.timetable')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.timetable') ? 'active' : ''); ?>" title="Timetable">
        ...
        <a href="<?php echo e(route('portal.student.academics')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.academics') ? 'active' : ''); ?>" title="Academics / LMS">
        ...
        <a href="<?php echo e(route('portal.student.exams')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.exams') ? 'active' : ''); ?>" title="Exam Results">
          <svg class="ps-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
          <span class="ps-nav-label">Exam Results</span>
        </a>
        ...
        <a href="<?php echo e(route('portal.student.fees')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.fees') ? 'active' : ''); ?>" title="Fees">
          <svg class="ps-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
          <span class="ps-nav-label">Fees</span>
        </a>
        ...
        <a href="<?php echo e(route('portal.student.notices')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.notices') ? 'active' : ''); ?>" title="Notices" id="ps-notices-link">
          <svg class="ps-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/></svg>
          <span class="ps-nav-label">Notices</span>
        </a>
        ...
        <a href="<?php echo e(route('portal.student.profile')); ?>" class="ps-nav-item <?php echo e(str_starts_with($route,'portal.student.profile') ? 'active' : ''); ?>" title="Profile">
          <svg class="ps-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
          <span class="ps-nav-label">My Profile</span>
        </a>
    ...
    <div class="ps-sidebar-footer">
      <div class="ps-user-row">
        <div class="ps-user-avatar">
          <span style="color:#fff;font-size:.7rem;font-weight:700;"><?php echo e(strtoupper(substr(auth()->user()->name,0,2))); ?></span>
        </div>
        <div class="ps-user-info">
          <p style="color:#f1f5f9;font-size:.8rem;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:130px;"><?php echo e(auth()->user()->name); ?></p>
          <p style="color:rgba(148,163,184,.6);font-size:.7rem;white-space:nowrap;"><?php echo e(auth()->user()->hasRole('parent') ? 'Parent' : 'Student'); ?></p>
        </div>
  ...
  <div class="ps-main">
    ...
    <header class="ps-topbar">
      ...
      <span class="ps-topbar-title"><?php echo $__env->yieldContent('title', 'Portal'); ?></span>
      ...
      <div style="width:2rem;height:2rem;border-radius:50%;background:linear-gradient(135deg,#3b82f6,#6366f1);display:flex;align-items:center;justify-content:center;flex-shrink:0;" title="<?php echo e(auth()->user()->name); ?>">
        <span style="color:#fff;font-size:.7rem;font-weight:700;"><?php echo e(strtoupper(substr(auth()->user()->name,0,2))); ?></span>
      </div>
...
<?php /**PATH E:\school_erp - Copy\resources\views\portal\layout.blade.php ENDPATH**/ ?>