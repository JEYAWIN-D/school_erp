...
<div class="container">
  <div class="header">
    <strong><?php echo e($schoolName); ?></strong> — Exam Result Notification
  </div>
  <div class="content">
    <p>Dear Parent/Guardian,</p>
    <p>We are pleased to share the exam result for <strong><?php echo e($studentName); ?></strong> for <strong><?php echo e($examName); ?></strong>.</p>
    <div class="result-box">
      <div class="stat">
        <div class="stat-value"><?php echo e($percentage); ?>%</div>
        <div style="font-size:12px;color:#6b7280;">Percentage</div>
      </div>
      <div class="stat">
        <div class="stat-value"><?php echo e($grade); ?></div>
        <div style="font-size:12px;color:#6b7280;">Grade</div>
      </div>
      <div class="stat">
        <div class="stat-value <?php echo e(strtolower($result)); ?>"><?php echo e($result); ?></div>
    ...
    <br>
    <p>Regards,<br><strong><?php echo e($schoolName); ?></strong></p>
  </div>
  <div class="footer">This is an automated message. Please do not reply to this email.</div>
</div>
</body>
</html>
<?php /**PATH E:\school_erp - Copy\resources\views\emails\result-notification.blade.php ENDPATH**/ ?>