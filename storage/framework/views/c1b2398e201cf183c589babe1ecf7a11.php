...
<div class="page">
  <div class="header">
    <h1><?php echo e($school?->school_name ?? 'School Name'); ?></h1>
    <div style="font-size:10px"><?php echo e($school?->address ?? ''); ?></div>
    <div style="font-size:10px">PAN of Deductor: <?php echo e($school?->pan_number ?? 'XXXXXXXXXX'); ?> | TAN: <?php echo e($school?->tan_number ?? 'XXXXXXXXXX'); ?></div>
  </div>
  ...
  <div style="font-size:10px;text-align:center;color:#555;margin-bottom:8px">
    Financial Year: <?php echo e($financialYear); ?> | Issued under Section 203 of the Income Tax Act, 1961
  </div>
  ...
  <table>
    ...
    <tr>
      ...
      <td><?php echo e($employee->pan_no ?? 'Not Available'); ?></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>01 April <?php echo e(substr($financialYear, 0, 4)); ?> to 31 March <?php echo e(substr($financialYear, -4)); ?></td>
    </tr>
    <tr>
      <td class="label-col">Tax Regime</td>
      <td><?php echo e(strtoupper($employee->tax_regime ?? 'new')); ?> REGIME</td>
    </tr>
  </table>
  ...
  <table>
    <tr>
      ...
      <td class="amount-col">₹ <?php echo e(number_format($annualGross, 2)); ?></td>
    </tr>
    <tr>
      <td class="label-col">2. Standard Deduction u/s 16(ia)</td>
      <td class="amount-col">₹ <?php echo e(number_format($tds['std_deduction'], 2)); ?></td>
    </tr>
    <?php if($employee->tax_regime === 'old'): ?>
    <tr>
      <td class="label-col">3. HRA Exemption u/s 10(13A)</td>
      <td class="amount-col">₹ <?php echo e(number_format($tds['hra_exemption'], 2)); ?></td>
    </tr>
    <tr>
      <td class="label-col">4. Deduction u/s 80C (LIC/PF/ELSS etc.)</td>
      <td class="amount-col">₹ <?php echo e(number_format($tds['invest_80c'], 2)); ?></td>
    </tr>
    <tr>
      <td class="label-col">5. Deduction u/s 80D (Medical Insurance)</td>
      <td class="amount-col">₹ <?php echo e(number_format($tds['invest_80d'], 2)); ?></td>
    </tr>
    <?php endif; ?>
    <tr class="total-row">
      <td>Net Taxable Income</td>
      <td class="amount-col">₹ <?php echo e(number_format($tds['taxable_income'], 2)); ?></td>
    </tr>
  </table>
  ...
  <table>
    <tr>
      ...
      <td class="amount-col">₹ <?php echo e(number_format($tds['base_tax'], 2)); ?></td>
    </tr>
    <tr>
      <td class="label-col">Health & Education Cess @ 4%</td>
      <td class="amount-col">₹ <?php echo e(number_format($tds['cess'], 2)); ?></td>
    </tr>
    <tr class="total-row">
      <td>Total Annual Tax Liability</td>
      <td class="amount-col">₹ <?php echo e(number_format($tds['annual_tax'], 2)); ?></td>
    </tr>
  </table>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m', $p->month)->format('M Y')); ?></td>
        <td style="text-align:right">₹ <?php echo e(number_format($p->gross_salary, 2)); ?></td>
        <td style="text-align:right">₹ <?php echo e(number_format($p->deductions, 2)); ?></td>
        <td style="text-align:right">₹ <?php echo e(number_format($p->net_salary, 2)); ?></td>
        <td style="text-align:right">₹ <?php echo e(number_format($p->tds_amount, 2)); ?></td>
      </tr>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <tr class="total-row">
        <td><strong>Total</strong></td>
        <td style="text-align:right"><strong>₹ <?php echo e(number_format($annualGross, 2)); ?></strong></td>
        <td style="text-align:right"><strong>₹ <?php echo e(number_format($totalDeductions, 2)); ?></strong></td>
        <td style="text-align:right"><strong>₹ <?php echo e(number_format($netPaid, 2)); ?></strong></td>
        <td style="text-align:right"><strong>₹ <?php echo e(number_format($totalTds, 2)); ?></strong></td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="sign-row">
    <div class="sign-box">
      <div class="sign-line">Date: <?php echo e(now()->format('d M Y')); ?></div>
    </div>
    <div class="sign-box">
...
<?php /**PATH E:\school_erp - Copy\resources\views\pdf\form-16.blade.php ENDPATH**/ ?>