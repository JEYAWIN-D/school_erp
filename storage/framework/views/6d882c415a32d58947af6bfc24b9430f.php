...
<div class="page">
  <div class="header">
    ...
    <div class="ticket-title">HALL TICKET — <?php echo e($exam->name); ?></div>
    <div style="font-size:11px;color:#888">Academic Year: <?php echo e($academicYear->name ?? ''); ?></div>
  </div>
  <?php if(isset($qrCode)): ?>
  <div class="qr-section">
    <img src="data:image/png;base64,<?php echo e($qrCode); ?>" alt="QR Code" width="90" height="90">
    <p>Scan to Verify</p>
  </div>
  <?php endif; ?>
  <table class="info-table">
    <tr><td>Candidate Name</td><td><?php echo e($student->full_name); ?></td></tr>
    ...
    <tr><td>Roll Number</td><td><?php echo e($enrollment?->roll_number); ?></td></tr>
    <tr><td>Date of Birth</td><td><?php echo e($student->dob?->format('d/m/Y')); ?></td></tr>
  </table>
  ...
  <table class="schedule-table">
    ...
    <tbody>
      ...
      <tr>
        <td><?php echo e(\Carbon\Carbon::parse($s->exam_date)->format('d M Y')); ?></td>
        <td><?php echo e($s->subject?->name); ?></td>
        <td><?php echo e($s->start_time); ?> – <?php echo e($s->end_time); ?></td>
        <td><?php echo e($s->duration_minutes ?? 180); ?> min</td>
        <td><?php echo e($s->max_marks); ?></td>
        <td><?php echo e($s->venue ?? 'Main Hall'); ?></td>
      </tr>
...
<?php /**PATH E:\school_erp - Copy\resources\views\pdf\hall-ticket.blade.php ENDPATH**/ ?>