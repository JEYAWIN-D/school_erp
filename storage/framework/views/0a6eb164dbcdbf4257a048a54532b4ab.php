...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="receipt-no">Receipt # <?php echo e($payment->receipt_number); ?></div>
  </div>

  <table class="info-table">
    <tr>
      <td class="label">Student Name</td>
      <td class="value"><?php echo e($student->full_name); ?></td>
      <td class="label">Admission No.</td>
      <td class="value"><?php echo e($student->admission_no); ?></td>
    </tr>
    <tr>
      <td class="label">Class</td>
      <td class="value"><?php echo e($enrollment?->class_name ?? '—'); ?></td>
      <td class="label">Payment Date</td>
      <td class="value"><?php echo e(\Carbon\Carbon::parse($payment->payment_date)->format('d M Y')); ?></td>
    </tr>
  </table>
  ...
  <div class="detail-box">
    <div class="detail-row">
      ...
      <div class="detail-right"><?php echo e($payment->fee_head_name ?? 'General Fee'); ?></div>
    </div>
    <div class="detail-row">
      <div class="detail-left">Fee Amount</div>
      <div class="detail-right">₹<?php echo e(number_format($payment->amount, 2)); ?></div>
    </div>
    <?php if($payment->discount > 0): ?>
    <div class="detail-row">
      <div class="detail-left" style="color:#16a34a;">Discount</div>
      <div class="detail-right" style="color:#16a34a;">- ₹<?php echo e(number_format($payment->discount, 2)); ?></div>
    </div>
    <?php endif; ?>
    <?php if($payment->late_fee > 0): ?>
    <div class="detail-row">
      <div class="detail-left" style="color:#dc2626;">Late Fee</div>
      <div class="detail-right" style="color:#dc2626;">+ ₹<?php echo e(number_format($payment->late_fee, 2)); ?></div>
    </div>
    <?php endif; ?>

    <div class="total-box">
      <div class="total-left">Amount Paid</div>
      <div class="total-right">₹<?php echo e(number_format($payment->total_paid, 2)); ?></div>
    </div>
  </div>

  <div style="margin-bottom:16px;">
    <span style="color:#64748b;font-size:11px;">Payment Mode: </span>
    <span class="mode-badge"><?php echo e(strtoupper(str_replace('_',' ',$payment->payment_mode ?? 'cash'))); ?></span>
    <?php if($payment->transaction_id): ?>
    <span style="color:#64748b;font-size:11px;margin-left:12px;">Transaction ID: </span>
    <span style="font-weight:bold;font-size:11px;"><?php echo e($payment->transaction_id); ?></span>
    <?php endif; ?>
  </div>

  <?php if($payment->remarks): ?>
  <div style="font-size:10px;color:#64748b;">Remarks: <?php echo e($payment->remarks); ?></div>
  <?php endif; ?>
  ...
  <div class="footer">
    This is a computer generated receipt — no signature required. | Generated on <?php echo e(now()->format('d M Y h:i A')); ?>

  </div>
</div>
</body>
</html>
<?php /**PATH E:\school_erp - Copy\resources\views\portal\pdf\payment-receipt.blade.php ENDPATH**/ ?>