...
<div class="header">
  ...
  <?php if($school->affiliation_number ?? null): ?>
  <div class="school-info">Affiliation No: <?php echo e($school->affiliation_number); ?></div>
  <?php endif; ?>
</div>
...
<div class="ref-row">
  <span>Ref: <?php echo e($enquiry->enquiry_number); ?></span>
  <span>Date: <?php echo e(now()->format('d F Y')); ?></span>
</div>

<div class="salutation">
  To,<br>
  <strong><?php echo e($enquiry->parent_name); ?></strong><br>
  <?php if($enquiry->address): ?><?php echo e($enquiry->address); ?><br><?php endif; ?>
</div>

<div class="body-text">
  <p>Dear <?php echo e($enquiry->parent_name); ?>,</p>

  <p>We are pleased to inform you that your ward <span class="highlight"><?php echo e($enquiry->student_name); ?></span> has been provisionally admitted to <span class="highlight"><?php echo e($school->school_name ?? config('app.name')); ?></span> for the academic year <span class="highlight"><?php echo e($enquiry->academicYear?->name ?? date('Y').'-'.(date('Y')+1)); ?></span>.</p>

  <p>Please find the admission details below:</p>
</div>

<table class="details">
  <tr><td>Student Name</td><td><?php echo e($enquiry->student_name); ?></td></tr>
  <tr><td>Class Admitted</td><td><?php echo e($enquiry->class?->name ?? '—'); ?></td></tr>
  <tr><td>Academic Year</td><td><?php echo e($enquiry->academicYear?->name ?? date('Y').'-'.(date('Y')+1)); ?></td></tr>
  <tr><td>Enquiry Reference</td><td><?php echo e($enquiry->enquiry_number); ?></td></tr>
  <tr><td>Parent / Guardian</td><td><?php echo e($enquiry->parent_name); ?></td></tr>
  <tr><td>Contact Number</td><td><?php echo e($enquiry->parent_mobile); ?></td></tr>
  <tr><td>Date of Confirmation</td><td><?php echo e(now()->format('d F Y')); ?></td></tr>
</table>
...
<div class="body-text">
  ...
  <p>For any queries, please contact the school office. We look forward to welcoming <?php echo e($enquiry->student_name); ?> into our school family.</p>
</div>
...
<?php /**PATH E:\school_erp - Copy\resources\views\pdf\admission-confirmation.blade.php ENDPATH**/ ?>