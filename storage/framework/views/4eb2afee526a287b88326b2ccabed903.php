  ...
  <aside id="sidebar"
    ...
    <div class="flex items-center gap-3 px-4 py-4 border-b border-white/10 flex-shrink-0">
      ...
      <div class="flex-1 overflow-hidden" x-show="sidebarOpen || isMobile">
        <p class="text-white font-extrabold text-base leading-tight truncate" style="font-family:'Plus Jakarta Sans',sans-serif;"><?php echo e(config('app.name', 'DASA EduERP')); ?></p>
  ...
  <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
    ...
    <header class="h-14 bg-white border-b border-slate-200 flex items-center px-2.5 sm:px-4 md:px-6 gap-2 sm:gap-3 flex-shrink-0 z-20">
      ...
      <div class="flex-1 min-w-0 flex items-center gap-1.5 text-xs text-slate-400 overflow-hidden">
        <a href="<?php echo e(route('dashboard')); ?>" class="hover:text-slate-600 transition flex-shrink-0">Home</a>
        <?php if (! empty(trim($__env->yieldContent('breadcrumb')))): ?>
          <span class="flex-shrink-0">/</span>
          <span class="truncate font-medium text-slate-600"><?php echo $__env->yieldContent('breadcrumb'); ?></span>
        <?php endif; ?>
      </div>
    ...
    <main class="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 pb-safe page-enter">
      ...
      <?php if(session('success')): ?>
        <div class="alert-success mb-4 sm:mb-5">
          ...
          <span class="break-words"><?php echo e(session('success')); ?></span>
        </div>
      <?php endif; ?>
      <?php if(session('error')): ?>
        <div class="alert-error mb-4 sm:mb-5">
          <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
          <span class="break-words"><?php echo e(session('error')); ?></span>
        </div>
      <?php endif; ?>
