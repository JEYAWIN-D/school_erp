...
# Payslip for <?php echo e($month); ?>


Dear <?php echo e($employee->full_name); ?>,

Please find your payslip for **<?php echo e($month); ?>** attached to this email.
...
| Details | Amount |
|:--------|-------:|
| Gross Salary | ₹<?php echo e(number_format($payroll->gross_salary ?? 0, 2)); ?> |
| Total Deductions | ₹<?php echo e(number_format($payroll->total_deductions ?? 0, 2)); ?> |
| **Net Pay** | **₹<?php echo e(number_format($payroll->net_salary ?? 0, 2)); ?>** |
...
<?php endif; ?>
<?php /**PATH E:\school_erp - Copy\resources\views\emails\payslip.blade.php ENDPATH**/ ?>