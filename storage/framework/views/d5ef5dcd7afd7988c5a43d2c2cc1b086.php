...
<div class="notice-date">Date: <?php echo e(now()->format('d F Y')); ?></div>

<div class="to-block">
  <p>To,</p>
  <strong>Parent / Guardian of</strong><br>
  <strong><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></strong><br>
  Class: <?php echo e($student->currentEnrollment?->class?->name ?? '—'); ?><br>
  Admission No: <?php echo e($student->admission_no ?? $student->admission_number ?? '—'); ?>
...
<p>
  ...
  <strong><?php echo e($currentYear?->name ?? now()->year); ?></strong>. Kindly clear the outstanding balance at the earliest.
</p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><?php echo e($due['feeHead']?->name ?? '—'); ?></td>
      <td>₹<?php echo e(number_format($due['amount'], 2)); ?></td>
      <td>₹<?php echo e(number_format($due['paid'], 2)); ?></td>
      <td><strong>₹<?php echo e(number_format($due['balance'], 2)); ?></strong></td>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <tr class="total-row">
      <td>TOTAL</td>
      <td>₹<?php echo e(number_format($dues->sum('amount'), 2)); ?></td>
      <td>₹<?php echo e(number_format($dues->sum('paid'), 2)); ?></td>
      <td>₹<?php echo e(number_format($dues->sum('balance'), 2)); ?></td>
    </tr>
  </tbody>
</table>

<div class="warning-box">
  <strong>Important:</strong> If the outstanding balance of <strong>₹<?php echo e(number_format($dues->sum('balance'), 2)); ?></strong>
...
<p>For any queries, contact the accounts office at: <?php echo e($school?->phone ?? '—'); ?></p>
...
<?php /**PATH E:\school_erp - Copy\resources\views\pdf\demand-notice.blade.php ENDPATH**/ ?>