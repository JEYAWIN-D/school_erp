<?php $__env->startSection('title', 'Transfer Certificate — ' . $student->full_name); ?>
    ...
    <table class="w-full text-sm border-collapse">
      ...
      <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $value]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr class="border-b border-slate-200">
          <td class="py-2.5 pr-4 font-semibold text-slate-600 w-2/5"><?php echo e($label); ?></td>
          <td class="py-2.5 text-slate-800"><?php echo e($value); ?></td>
        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_erp - Copy\resources\views\students\tc.blade.php ENDPATH**/ ?>